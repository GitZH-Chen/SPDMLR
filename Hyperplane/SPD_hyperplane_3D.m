...
ith=2;
subplot(1,total_num,ith)
% A_vec={[1,1,0.5],[1,1,2],[1,1,100]};
A_vec={[0.5,0,1],[2,0,1],[100,0,1]};
print_SPD(X_spd,Y_spd,Z_spd,size,A_vec,metric{ith},num,fontsize,max_bound)

hfig = gcf;
figWidth = 16;  % Width of one column in inches (adjust as needed)
figHeight = 5; % Height of the figure in inches (adjust as needed)
...
fileout = append('hyperplanes_all','.');
